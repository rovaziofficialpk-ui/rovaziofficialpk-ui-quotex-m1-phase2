  ...
  return (
    <div>
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-slate-400">Phase 3 checks the screenshot locally before sending anything to the AI</p>
      </div>
      ...
      <label className="block cursor-pointer">
        <div className="border-2 border-dashed border-slate-700 hover:border-green-400 rounded-xl p-10 text-center transition-all group bg-slate-900/30">
          ...
          <p className="text-lg font-bold mb-1">Drop Primary M1 Chart Screenshot</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mt-8">
        {[
          ['🔎', 'Preflight', 'Local quality heuristics'],
          ['🧭', 'Context', 'Optional M5 / H1'],
