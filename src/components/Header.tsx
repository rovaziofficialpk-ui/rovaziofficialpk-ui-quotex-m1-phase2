      ...
      <div className="max-w-[1400px] mx-auto px-3 py-2 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="hidden md:block text-[8px] text-slate-600 uppercase tracking-widest">Stage 3D acceptance hygiene · audit lock on</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="hidden sm:flex items-center gap-1.5 px-2 py-1 bg-slate-800/50 rounded-md border border-slate-700">
            ...
            <span className="text-[10px] text-slate-400 font-mono">PHASE 4A.7</span>
          </div>
        </div>
      </div>
    </header>
