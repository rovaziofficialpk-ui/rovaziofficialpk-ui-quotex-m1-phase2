      ...
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500 uppercase tracking-widest">Live tab + smart auto-test chart analysis</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="hidden sm:flex items-center gap-1.5 px-2 py-1 bg-slate-800/50 rounded-md border border-slate-700">
            ...
            <span className="text-[10px] text-slate-400 font-mono">PHASE 3.2</span>
          </div>
        </div>
      </div>
    </header>
